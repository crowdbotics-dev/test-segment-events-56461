...
## Project Structure
    ...
    ├── test_segment_events_56461  # Django project configurations
...
1. Clone this repo and `cd test_segment_events_56461`
...
2. Clone this repo and `cd test_segment_events_56461`
